    ...
    return (
        <div className='flex flex-col justify-around mt-12'>
            ...
            <main className="flex flex-col md:flex-row pb-[8em] lg:pb-[6em]">
                ...
                <Image alt='ocelo' width={730} height={730} src="/un002.jpg" />
                ...
                <h1 className={`mb-2 text-4xl`} >
                    ...
                    <div className="text-left" >
                        ...
                        <p>
                        Debut mixtape by Buenos Aires-based digital hardcore duo.<br />
                        Selection of electronic compositions and improvisations recorded live during 2023
                        </p>
                       <br />
                        <p>
                            01. - antro [00:34]<br /> 
                            02. - 12 42 57 68 [01:44]<br /> 
                            03. - carta [01:16]<br /> 
                            04. - huesos afilados [03:14]<br /> 
                            05. - propulsor [02:29]<br /> 
                            06. - tecno [01:00]<br /> 
                            07. - 6167756a61 [04:08]<br /> 
                            08. - mar cuadrado [02:42]<br /> 
                            09. - sin título (bonus track) [04:26]<br /> 
                ...
                {/* <div >
                    ...
                    Mastering: Astrosuka, Sofja (Omu studios) */}

                    music, cover artwork, mastering: <Link href='https://astrosuka.xyz' ><a target="_blank" className=''>Astrosuka</a></Link> & <Link href='https://sofffja.com' ><a target="_blank" className=''>Sofja</a></Link>
                    </p>
                    <div className=''>released on November 11, 2023
                    </div>
                    <br />
